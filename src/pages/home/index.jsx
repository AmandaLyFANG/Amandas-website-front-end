...
const Home = () => {
  ...
  return (
    <div className="tm_content justify-center max-w-[1680px] place-content-center w-full mt-5 h-auto clear-both my-0 mx-auto py-0 px-[20px] demo">
      <div className="row justify-content-center mt-5">
        <div className="col-xl-9 col-12 my-5">
          ...
          >
            ...
            <p>
              My passion lies in the art of implementation — transforming ideas
              into reality with precision and creativity.
            </p>
            <p>
              I welcome the opportunity to connect and collaborate on innovative
              projects.
            </p>
      ...
      <div className="buttons justify-center w-full float-left flex items-center mb-[50px]">
        <div className="mx-5 bg-indigo-600 hover:bg-indigo-700 text-white font-bold py-2 px-4 rounded">
